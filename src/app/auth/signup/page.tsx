...
export default function SignupPage() {
  ...
  return (
    <div className="bg-background font-body text-on-background antialiased selection:bg-primary/20 min-h-screen">
      <main className="min-h-screen flex flex-col md:flex-row overflow-hidden">
        ...
        <section className="relative w-full md:w-[55%] h-64 md:h-auto overflow-hidden">
          ...
          <img
            ...
            src="https://images.pexels.com/photos/259447/pexels-photo-259447.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
          />
          <div className="absolute bottom-0 left-0 p-8 md:p-16 z-20 text-white max-w-2xl">
            <p className="font-label text-xs uppercase tracking-[0.2rem] mb-4 opacity-80">The Digital Frontier</p>
            <h1 className="font-headline text-4xl md:text-6xl font-black tracking-tighter leading-[0.9] mb-6">
              Claim Your Seat <br /> by the Campfire.
            </h1>
        ...
        <section className="w-full md:w-[45%] bg-surface flex items-center justify-center p-6 md:p-20">
          <div className="w-full max-w-md">
            <header className="mb-12">
              <h2 className="font-headline text-3xl font-extrabold text-on-background mb-2">Join the Tribe</h2>
              <p className="text-on-surface-variant font-medium">Create your explorer profile to begin your journey.</p>
            </header>
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              {/* Input: Full Name */}
              <div className="space-y-2">
                <label className="font-label text-[10px] uppercase tracking-[0.15rem] font-bold text-on-surface-variant" htmlFor="name">
                  Full Name
                </label>
              ...
              {/* Input: Email */}
              <div className="space-y-2">
                <label className="font-label text-[10px] uppercase tracking-[0.15rem] font-bold text-on-surface-variant" htmlFor="email">
                  Email Address
                </label>
                <div className="relative">
                  <input
            ...
            <footer className="mt-12 text-center">
              <p className="text-on-surface-variant font-medium">
                ...
                <Link className="text-secondary font-bold hover:underline underline-offset-4 ml-1" href="/auth/login">
                  Sign in
                </Link>
              </p>
            </footer>
      ...
      {/* Branding Element: Visual Accent */}
      <div className="fixed bottom-8 right-8 hidden lg:block pointer-events-none opacity-10">
        <span className="material-symbols-outlined text-9xl text-on-surface">landscape</span>
      </div>
    </div>
  );
}
